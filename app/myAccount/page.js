...
import { Settings, User, Package, CreditCard, LogOut, Edit, Camera } from 'lucide-react';
              ...
              {activeTab === 'profile' && (
                <div className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-md font-medium text-gray-800 mb-3">Shipping Address</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {/* Sample orders */}
                          <tr>
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">#ORD-3845</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Apr 20, 2025</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">$126.58</td>
                          ...
                          <tr>
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">#ORD-2947</td>
                        ...
                        <div className="flex-shrink-0 mr-4">
                          <div className="w-12 h-8 bg-gray-100 rounded flex items-center justify-center">
                            <svg className="w-8 h-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M28 7H4C3.44772 7 3 7.44772 3 8V24C3 24.5523 3.44772 25 4 25H28C28.5523 25 29 24.5523 29 24V8C29 7.44772 28.5523 7 28 7Z" stroke="#4F46E5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                              <path d="M3 13H29" stroke="#4F46E5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                          </div>
                        </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-4 relative hover:border-blue-500 transition">
                      <div className="flex items-start">
                        <div className="flex-shrink-0 mr-4">
                          <div className="w-12 h-8 bg-gray-100 rounded flex items-center justify-center">
                            <svg className="w-8 h-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M28 7H4C3.44772 7 3 7.44772 3 8V24C3 24.5523 3.44772 25 4 25H28C28.5523 25 29 24.5523 29 24V8C29 7.44772 28.5523 7 28 7Z" stroke="#FF9800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                              <path d="M3 13H29" stroke="#FF9800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                          </div>
                        </div>
                        <div className="flex-1">
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <h3 className="text-md font-medium text-gray-800 mb-2">Notification Preferences</h3>
                      <div className="space-y-3">
                        <div className="flex items-start">
                          ...
                          <div className="ml-3 text-sm">
                            ...
                            <p className="text-gray-500">Receive emails about order updates and new products</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <div className="flex items-center h-5">
                          ...
                          <div className="ml-3 text-sm">
                            ...
                            <p className="text-gray-500">Receive promotional offers and special discounts</p>
                          </div>
                        </div>
                      </div>
                    </div>
